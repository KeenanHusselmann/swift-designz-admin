  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/team/employees" className="glass-card p-8 text-center hover:border-teal/30 transition-colors">
        ...
        <Link href="/team/agents" className="glass-card p-8 text-center hover:border-teal/30 transition-colors">
          <Bot className="h-10 w-10 text-teal mx-auto mb-4" />
          <h3 className="text-lg font-medium text-foreground">AI Agents</h3>
